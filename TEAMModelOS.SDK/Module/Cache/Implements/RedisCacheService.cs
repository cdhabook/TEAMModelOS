...
using TEAMModelOS.SDK.Module.Cache.Interfaces;

namespace TEAMModelOS.SDK.Module.Cache.Implements
{
...
        public T GetCache<T>(string key) where T : class
        {
            ...
            return MessagePackHelper.JsonToObject<T>(cacheVal);
        }
...
        public void SetCache(string key, object value)
        {
            ...
            // 添加缓存
            _cache.Set(key, MessagePackHelper.ObjectToByte(value), options);
            //刷新缓存
            _cache.Refresh(key);
        }
